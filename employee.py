    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_emp_name.get()=="" or self.var_emp_id.get()=="":
            ...
            try:
                ...
                my_cursur.execute("insert into employee values(%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
        ...
        if self.var_dep.get()=="Select Department" or self.var_emp_name.get()=="" or self.var_emp_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="96096",database="employee_attendance_system")
                    my_cursur=conn.cursor()
                    my_cursur.execute("update employee set Emp_Name=%s,Gender=%s,DOB=%s,Phone=%s,Email=%s,Dep=%s,Address=%s,Photo=%s where Emp_Id=%s",(
    ...
    def generate_data(self):
        if self.var_dep.get() == "Select Department" or self.var_emp_name.get() == "" or self.var_emp_id.get() == "":
            ...
            try:
                ...
                my_cursor.execute("update employee set Emp_Name=%s,Gender=%s,DOB=%s,Phone=%s,Email=%s,Dep=%s,Address=%s,Photo=%s where Emp_Id=%s",(
